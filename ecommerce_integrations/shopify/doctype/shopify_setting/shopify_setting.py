...
from shopify.resources import Location, Customer
...
class ShopifySetting(SettingController):
    ...
    def import_all_customers(self):
        customer_list = self.get_all_customers()
        for customer_data in customer_list:
            shopify_customer = self.sync_customer(customer_data)
        frappe.msgprint(_("All customers imported successfully"))
